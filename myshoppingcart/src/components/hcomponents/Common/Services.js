...
const services = [
  {title: "Picnic", description: "Enjoy cakes with any road trips", icon: "fa-shopping-cart"},
  {title: "Birthday", description: "Happy Birthday", icon: 'fa-laptop' },
  {title: "Family outing",description: "Description goes here", icon: "fa-shopping-cart"}
];
