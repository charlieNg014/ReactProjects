...
const fields = {
    section: [
        ...
        [
            { name: 'message', elementName: 'textarea', type: 'textarea', placeholder: 'Type your message' }
        ]
    ]
}
    ...
    render() {
        return ( 
            <div>
                ...
                <div className = "col-lg-12 text-center" >
                <div id = "success" > </div>  
                <button id = "sendMessageButton" className = "btn btn-primary btn-xl submitbtn text-uppercase" type = "submit" > Send Message < /button>  </div > 
                </div>  
                </form > 
                </div>  
                </div > 
